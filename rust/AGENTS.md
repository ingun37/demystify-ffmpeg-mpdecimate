...
This is the sample code from the wgsl_to_wgpu repo's v0.19.0 rev. `compute_shader` and `shader` modules are the auto-generated reflection file. Look at this to figure out how to use wgsl_to_wgpu.
...
The @shaders/mpdecimate.wgsl is visualizing the *FFmpeg*'s *mpdecimate* filter. Here's the code snippet from the actual code  
